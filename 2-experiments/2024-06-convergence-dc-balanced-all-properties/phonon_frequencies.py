from sssp_verify_scripts.controllers import ConvergencePhononFrequenciesGroupSubmissionController
...
comment = f"{property}-convergence-experiment"
...
try:
    controller = ConvergencePhononFrequenciesGroupSubmissionController(
        group_label=target_group_label,
        parent_group_label=target_upf_lib,
        max_concurrent=5,
        pw_code=f"pw-7.0@{computer}",
        ph_code=f"ph-7.0@{computer}",
        protocol=protocol,
        configuration=conf,
