...
pseudos = {
 ...
 #'Na.nc.z_9.oncvpsp3.dojo.v0.5.0-std': (200.0, 700.0),
...
comment = "dojo-0.5-std"
#computer = 'eiger-mc-mr32-mem'
computer = 'daint-mc-mrcloud-mem'
mpiprocs = 36 # 128 for eiger
npool = 4 # 8 for eiger
base_path = "/home/jyu/Projects/WP-SSSP/sssp-verify-scripts/libraries-pbe/NC-DOJOv0.5-standard"
