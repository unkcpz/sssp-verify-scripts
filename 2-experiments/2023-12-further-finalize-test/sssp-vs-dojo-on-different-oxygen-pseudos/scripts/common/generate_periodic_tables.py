...
if len(sys.argv) == 2:
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2a":
        ...
        USE_AE_AVERAGE_AS_REFERENCE = True
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["sample-elements|QE|dojo-v0.5-oxygen-pseudo"]
        SET_NAME = ['oxides']
        QUANTITIES=["nu"]
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2b":
        ...
        USE_AE_AVERAGE_AS_REFERENCE = True
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["sample-elements|QE|sssp-v1.3-oxygen-pseudo"]
        SET_NAME = ['oxides']
        QUANTITIES=["nu"]
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2c":
        ...
        USE_AE_AVERAGE_AS_REFERENCE = True
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["uspp-pseudos|QE|dojo-v0.5-oxygen-pseudo"]
        SET_NAME = ['oxides']
        QUANTITIES=["nu"]
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2d":
        ...
        USE_AE_AVERAGE_AS_REFERENCE = True
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["uspp-pseudos|QE|sssp-1.3-oxygen-pseudo"]
        SET_NAME = ['oxides']
        QUANTITIES=["nu"]
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2e":
        ...
        USE_AE_AVERAGE_AS_REFERENCE = True
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["dojo-pseudos|QE|dojo-0.5-oxygen-pseudo"]
        SET_NAME = ['oxides']
        QUANTITIES=["nu"]
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2f":
        ...
        USE_AE_AVERAGE_AS_REFERENCE = True
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["dojo-pseudos|QE|sssp-1.3-oxygen-pseudo"]
        SET_NAME = ['oxides']
        QUANTITIES=["nu"]
