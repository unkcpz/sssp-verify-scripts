...
if len(sys.argv) == 2:
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2a":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "PseudoDojo-v0.5b1|abinit@ACWF"
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["PseudoDojo-v0.5|qe@SSSP"]
        QUANTITIES=["epsilon"]

    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2b":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "PseudoDojo-v0.5b1|abinit@ACWF"
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["PseudoDojo-v0.4.1|qe@SSSP"]
        QUANTITIES=["epsilon"]

    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2c":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "Quantum ESPRESSO@PW|PseudoDojo-v0.4"
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["PseudoDojo-v0.5|qe@SSSP"]
        QUANTITIES=["epsilon"]

    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2d":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "Quantum ESPRESSO@PW|PseudoDojo-v0.4"
        LABELS_KEY = 'methods-main'
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2e":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "ABINIT@PW|PseudoDojo-v0.4"
        LABELS_KEY = 'methods-main'
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2f":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "ABINIT@PW|PseudoDojo-v0.4"
        LABELS_KEY = 'methods-main'
    ...
    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2g":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "ABINIT@PW|PseudoDojo-v0.4"
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["Quantum ESPRESSO@PW|PseudoDojo-v0.4"]
        QUANTITIES=["epsilon"]

    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2h":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "ABINIT@PW|PseudoDojo-v0.4"
        LABELS_KEY = 'methods-main'
        ONLY_CODES = ["PseudoDojo-v0.5b1|abinit@ACWF"]
        QUANTITIES=["epsilon"]

    if sys.argv[1] == "SI-PSEUDODOJO-SECTION-2m":
        # Section S16
        USE_AE_AVERAGE_AS_REFERENCE = False
        REFERENCE_CODE_LABEL = "PseudoDojo-v0.5b1|abinit@ACWF"
        LABELS_KEY = 'methods-main'
