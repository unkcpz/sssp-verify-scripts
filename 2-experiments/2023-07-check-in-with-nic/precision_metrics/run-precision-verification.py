...
for pseudo in pseudos:
    ...
    command = f"aiida-sssp-workflow launch --property measure.precision --pw-code pw-7.0@eiger-mc-mr32-mem --ph-code ph-7.0@eiger-mc-mr32-mem --protocol acwf --cutoff-control standard --withmpi True --num-mpiprocs 128 --npool 8  -- {pseudo_path}"
    os.system(command)
    # print(command)
