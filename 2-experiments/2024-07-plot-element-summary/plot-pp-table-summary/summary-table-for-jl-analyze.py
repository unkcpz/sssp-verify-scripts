...
def summary(element):
    ...
    stable_conf: str = conf_mapping[element]
    ...
    for pp_name in pps:
        ...
        ereport['stable_conf'] = stable_conf.upper()
        ...
        try:
            ...
            abbr_name = lib_abbr_name_mapping[eos_dataset.attrs.get('lib_name')]
            ...
            nu_confs = {}
            eosdata = eos_mapping[element][abbr_name]
            for conf, data in eosdata.items():
                nu = data['nu']
                tot_nu += nu
                n_nu += 1
