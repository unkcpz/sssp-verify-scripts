...
def dump_output(element, pks, folder, override):
...
@click.option('-O', '--override/--no-override', default=False, help='if the pseudo info exist override it.')
@click.argument('nodes', nargs=-1)
def run(element, folder, override, nodes):
    # pk_list = [62683, 62693, 62709, 62727, 62814, 62895, 62968, 63045]
    dump_output(element=element, pks=nodes, folder=folder, override=override)
